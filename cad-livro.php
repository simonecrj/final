        ...
        <section class="container">
            ...
            <form action="inserir-livro.php" method="post" enctype="multipart/form-data">
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" id="" placeholder="" name="nome" required>
                </div>
                <div class="form-group col-md-5">
                    <label for="">Autor(a)</label>
                    <input type="text" class="form-control" id="" placeholder="" name="autor" required>
                </div>
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" id="" placeholder="" name="editora" required>
                </div>
                <div class="form-group col-md-5">
                    <label for="">Sinopse</label>
                    <textarea class="form-control" id="" rows="3" name="sinopse" required></textarea>
                </div>
                <div class="form-group col-md-5">
                    <label for="">Capa do Livro</label>
                    <input type="file" class="form-control-file" id="" name="foto" required>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <input type="text" class="form-control" id="" placeholder="" name="valor" required>
                </div>
