...
if(!isset($_GET['pesquisar'])){
    ...
    $result_sql = "SELECT * FROM livros WHERE nomelivro LIKE '%$valor_pesquisar%'";
    ...
    $result_sqls = "SELECT * FROM livros WHERE nomelivro LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
